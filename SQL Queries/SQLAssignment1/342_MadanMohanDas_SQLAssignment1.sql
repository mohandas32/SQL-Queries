...
-- 2). creating table MDEmployee342
	...
	CREATE TABLE MDEmployee(
		...
		MDEmployeeDOB DATE,
		MDEmployeeAge TINYINT, -- range of TINYINT is 0 to 255
...
-- 3). performing alter command on table
	...
	EXEC sp_RENAME 'MDEmployee.MDEmployeeADDress', 'MDEmployeeAddress', 'COLUMN' --changing column name 
																				 --MDEmployeeADDress to MDEmployeeAddress
...
-- 4). applying constraints on column using alter command
	...
	--c)DEFAULT
		...
		ALTER TABLE MDEmployee ADD DEFAULT current_timestamp FOR CreatedON;  --Adding DEFAULT value to CreatedON COLUMN
		ALTER TABLE MDEmployee ADD DEFAULT '2023-01-23' FOR MDEmployeeDOJ;

	--d)CHECK
		ALTER TABLE MDEmployee ADD CONSTRAINT check_age CHECK (MDEmployeeAge>=18 AND MDEmployeeAge <=80);
...
--5). Inserting records in tables
	...
	VALUES
	('MadanMohan', 'Das', 'Male', 'D cabin,Sabarmati, Ahmedabad', '2000-03-01', 78, 
	'+91','9899827272','898987777','moha23n@gmail.com','Ahmedabad',344455, 1, 'Software Developer Trainee', 20000),

	('Vikrant', 'Anand', 'Male', 'Bopal Gam', '2002-08-02', 38,
	'+91','9899827000','9099877767','vkanand@gmail.com','Ahmedabad',390008, 2, 'Software Developer Trainee', 22000 ),

	('Jatin', 'Dhote', 'Male', '12/2 Sanskruti society,near bopal gam', '2000-10-12', 38,
	'+91','9999827000','9090977767','katind@gmail.com','Ahmedabad',391108, 1, 'Software Developer Trainee', 20000),

	('Niki','Patel','Female','11/2 Anand Complex,near IOC road, chandkheda','1998-02-10',25,
	'+91','9000667656','9988776655','nkpatel@yahoo.com','Ahmedabad',358800,3,'Software Developer Trainee',22000),

	('Shashank','Kirad','Male','87/2 Narmada Society, near navrangpura','1995-12-01',28,
	'+91','9001617181','8900980989','shashank@gmail.com','Ahmedabad',380005,2,'Software Developer Trainee',18500.50),

	('Raj','Barot','Male','Sargasan','1998-10-10',25,
	'+91','9990002233','9090908080','rajb@outlook.com','Gandhinagar',310023,1,'Software Developer Trainee',20000.25);
	...
	VALUES
	( 'Mihir', 'Patel', 'Male', '147 Shaligram Complex, near Vaishodevi circle', '2000-12-12', 30, 
	'+91','8988776523','8777090999','mihirp@gmail.com','Ahmedabad',390098, 3, 'Software Developer Trainee', 22000.50, 
	'2023-02-28 11:12:11.123','HR Shaligram'),

	( 'Vedang', 'Prajapati', 'Male', '14 Satyam Complex, near science city', '2002-11-11', 35, 
	'+91','9998776523','8777000999','vedangp@gmail.com','Ahmedabad',300898, 5, 'Software Developer Trainee', 20000.50, 
	'2023-03-28 10:10:10.111','HR Shaligram'),

	( 'Dhruvi','Modi','Female','23 Satya Complex, near AMC market vasna','1995-12-12',28,
	'+91','9898987676','9725676767','modidhrumil@gmail.com','Ahmedabad',399099,2,'Software Developer Trainee',21500,
	'2023-02-12 11:23:23.100','HR Shaligram'),

	( 'Chirag','Jadav','Male','12/11 Rajiv Opal, near manigar brts','2002-12-01',21,
	'+91','9990098987','9989887767','chiragj@yahoo.com','Ahmedabad',342525,2,'Software Developer Trainee',18000.50,
	'2023-01-29 15:23:23.232','HR Shaligram');
...
--7). Updating records of the table
	...
	COMMIT TRAN --commit(saving chages permanently)
	ROLLBACK TRAN --undo changes before commiting
...
--8). Retriving record from table
		...
		--selecting employee whose birth year is between 1990 and 2000
